...
@RestController
@RequestMapping("/api/master-data/capacity-units")
public class CapacityUnitController {
    private static final MasterConfig CONFIG = new MasterConfig("vehicle_capacity_units", "unit_code", "unit_name", "MASTER_CAPACITY_UNIT");
    private final MasterOptionService service;
    public CapacityUnitController(MasterOptionService service) { this.service = service; }
