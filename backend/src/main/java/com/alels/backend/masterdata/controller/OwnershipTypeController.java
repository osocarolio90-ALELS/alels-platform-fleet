...
@RestController
@RequestMapping("/api/master-data/ownership-types")
public class OwnershipTypeController {
    private static final MasterConfig CONFIG = new MasterConfig("vehicle_ownership_types", "ownership_code", "ownership_name", "MASTER_OWNERSHIP_TYPE");
    private final MasterOptionService service;
    public OwnershipTypeController(MasterOptionService service) { this.service = service; }
