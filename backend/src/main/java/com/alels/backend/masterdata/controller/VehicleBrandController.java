...
@RestController
@RequestMapping("/api/master-data/vehicle-brands")
public class VehicleBrandController {
    private static final MasterConfig CONFIG = new MasterConfig("vehicle_brands", "brand_code", "brand_name", "MASTER_VEHICLE_BRAND");
    private final MasterOptionService service;
    public VehicleBrandController(MasterOptionService service) { this.service = service; }
