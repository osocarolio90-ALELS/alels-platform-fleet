export type TripSummary={id:string;type:"TRIP"|"STOP";status:"COMPLETED"|"IN_PROGRESS";startTime:string;endTime:string;durationSeconds:number;distanceKm:number;averageSpeed:number;maximumSpeed:number;driverName:string;vehiclePlateNumber?:string|null;fuelConsumption?:number|null;fuelStart?:number|null;fuelFinish?:number|null;startLatitude?:number|null;startLongitude?:number|null;endLatitude?:number|null;endLongitude?:number|null};
