export type TripSummary={id:string;type:"TRIP"|"IDLE"|"STOP";status:"COMPLETED"|"IN_PROGRESS";startTime:string;endTime:string;durationSeconds:number;distanceKm:number;averageSpeed:number;maximumSpeed:number;driverName:string;vehiclePlateNumber?:string|null;operationCost?:number|null;fuelCost?:number|null;roadCost?:number|null;costCurrency?:string|null;fuelConsumption?:number|null;fuelStart?:number|null;fuelFinish?:number|null;startLatitude?:number|null;startLongitude?:number|null;endLatitude?:number|null;endLongitude?:number|null};
...
export type TripEvent={id:number;telemetryId?:number|null;title:string;message:string;severity:string;occurredAt:string;latitude?:number|null;longitude?:number|null;speed?:number|null;locationSource?:"TRIGGER_TELEMETRY_GPS"|"EVENT_RECORDED_GPS"|string|null};
