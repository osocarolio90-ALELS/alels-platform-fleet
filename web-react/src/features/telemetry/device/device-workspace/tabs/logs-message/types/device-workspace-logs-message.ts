...
export type TrafficRow={id:number;timestamp:string;eventType:string;title:string;imei:string;receivedBytes:number|null;sentBytes:number|null;remoteAddress:string|null;transport:string|null;protocol:string|null;status:string;details:string|null};
