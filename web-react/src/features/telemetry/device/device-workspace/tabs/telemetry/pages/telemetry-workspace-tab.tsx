 ...
 return <div className="dw-telemetry-layout">
  <div className="dw-left-column">
   <section ref={clusterRef} className="dw-cluster dw-sticky-cluster" data-cluster-theme="dark">
    <TelemetryMap latitude={data.position.latitude} longitude={data.position.longitude} angle={data.position.angle} vehicleType={data.vehicle.type} track={data.track||[]} threeDimensional={mapMode==="3d"} zoom={zoom}/>
