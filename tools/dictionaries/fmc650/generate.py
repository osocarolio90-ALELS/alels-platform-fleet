...
MODEL = "FMC650"
URL = "https://wiki.teltonika-gps.com/view/FMC650_Teltonika_Data_Sending_Parameters_ID"
        ...
        try:
            ...
            for _, row in table.iterrows():
                ...
                avl[avl_id] = {
                    ...
                    "bytes": clean(row.get(bytes_col, ""))
                    if bytes_col
                    else "",

                    "type": clean(row.get(type_col, ""))
                    if type_col
                    else "",

                    "unit": clean(row.get(units_col, ""))
                    if units_col
                    else "",
