...
MODEL = "FMC150"
URL = "https://wiki.teltonika-gps.com/view/FMC150_Teltonika_Data_Sending_Parameters_ID"
...
def main():
    ...
    for table_index, table in enumerate(tables):
        try:
            ...
            id_col = name_col = bytes_col = type_col = None
            multiplier_col = units_col = description_col = category_col = None
            ...
            print(f"[INFO] Table {table_index} -> ID={id_col} NAME={name_col}")
            ...
            for _, row in table.iterrows():
                ...
                avl[avl_id] = {
                    ...
                    "multiplier": parse_multiplier(row.get(multiplier_col, "")) if multiplier_col else 1,
    ...
    output = {
        ...
        "source": URL,
        "total_avl": len(avl),
        "avl": dict(sorted(avl.items(), key=lambda x: int(x[0])))
    }
